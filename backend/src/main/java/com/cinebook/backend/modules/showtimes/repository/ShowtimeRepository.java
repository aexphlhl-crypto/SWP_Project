...
public interface ShowtimeRepository extends JpaRepository<Showtime, Long> {
    ...
    Long countDistinctMoviesWithShowtimes();
    ...
    boolean existsConflictingShowtime(@Param("roomId") Long roomId, @Param("startTime") LocalDateTime startTime,
    ...
    boolean existsConflictingShowtimeForUpdate(@Param("roomId") Long roomId,
            @Param("excludeShowtimeId") Long excludeShowtimeId, @Param("startTime") LocalDateTime startTime,
            @Param("endTime") LocalDateTime endTime);
