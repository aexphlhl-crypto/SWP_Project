...
public class EmailService {
        ...
        public void sendBookingConfirmation(String to, com.cinebook.backend.modules.bookings.dto.MyBookingDto booking) {
                ...
                content.append("<tr><td style='padding: 8px; border: 1px solid #ddd;'><strong>Mã đặt vé:</strong></td><td style='padding: 8px; border: 1px solid #ddd;'>")
                                .append(booking.getId()).append("</td></tr>");
                content.append("<tr><td style='padding: 8px; border: 1px solid #ddd;'><strong>Phim:</strong></td><td style='padding: 8px; border: 1px solid #ddd;'>")
                                .append(booking.getMovieTitle()).append("</td></tr>");
                content.append("<tr><td style='padding: 8px; border: 1px solid #ddd;'><strong>Rạp:</strong></td><td style='padding: 8px; border: 1px solid #ddd;'>")
                                .append(booking.getCinemaName()).append("</td></tr>");
                content.append("<tr><td style='padding: 8px; border: 1px solid #ddd;'><strong>Phòng chiếu:</strong></td><td style='padding: 8px; border: 1px solid #ddd;'>")
                                .append(booking.getRoomName()).append("</td></tr>");
                content.append("<tr><td style='padding: 8px; border: 1px solid #ddd;'><strong>Ngày chiếu:</strong></td><td style='padding: 8px; border: 1px solid #ddd;'>")
                                .append(booking.getShowDate()).append("</td></tr>");
                content.append("<tr><td style='padding: 8px; border: 1px solid #ddd;'><strong>Giờ chiếu:</strong></td><td style='padding: 8px; border: 1px solid #ddd;'>")
                                .append(booking.getShowTime()).append("</td></tr>");
                content.append("<tr><td style='padding: 8px; border: 1px solid #ddd;'><strong>Ghế:</strong></td><td style='padding: 8px; border: 1px solid #ddd;'>")
                                .append(booking.getSeatNumber()).append("</td></tr>");
                content.append("<tr><td style='padding: 8px; border: 1px solid #ddd;'><strong>Tổng tiền:</strong></td><td style='padding: 8px; border: 1px solid #ddd;'>")
                ...
                if (booking.getFnbItems() != null && !booking.getFnbItems().isEmpty()) {
                        ...
                        for (com.cinebook.backend.modules.bookings.dto.FnBItemDto item : booking.getFnbItems()) {
                                content.append("<li>").append(item.getProductName()).append(" (x")
                                                .append(item.getQuantity()).append(")</li>");
                        }
                        content.append("</ul>");
                }
                ...
                if (booking.getTickets() != null) {
                        for (com.cinebook.backend.modules.bookings.dto.TicketDto ticket : booking.getTickets()) {
                                ...
                                String label = "FNB".equals(ticket.getSeatType()) ? "Bắp nước"
                                                : "Ghế " + ticket.getSeatLabel();
                                content.append("<p style='margin: 5px 0 0 0; font-size: 14px; color: #555;'>")
