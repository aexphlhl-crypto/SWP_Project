...
export default function AdminMoviesPage() {
  ...
  const [formData, setFormData] = useState({
    title: '', synopsis: '', director: '', castList: '', releaseDate: new Date().toISOString().split('T')[0], trailerUrl: '', poster: '', duration: '', status: 'now_showing', ageRating: 'PG-13', rating: 0, genreIds: [], actorIds: []
  });
  ...
  const openAdd = () => {
    ...
    setFormData({ title: '', synopsis: '', director: '', castList: '', releaseDate: new Date().toISOString().split('T')[0], trailerUrl: '', poster: '', duration: '', status: 'now_showing', ageRating: 'PG-13', rating: 0, genreIds: [], actorIds: [] });
